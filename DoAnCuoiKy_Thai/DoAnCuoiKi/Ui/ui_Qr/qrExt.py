...
from DoAnCuoiKy_Thai.DoAnCuoiKi.Ui.ui_Qr.qr import Ui_MainWindow
from DoAnCuoiKy_Thai.DoAnCuoiKi.Ui.ui_DangNhap.login import Ui_MainWindow1 as Ui_LoginWindow
