...
from DoAnCuoiKy.Ui.ui_PhieuXacNhan.PhieuXacNhanExt import PhieuXacNhanExt
from DoAnCuoiKy.Ui.ui_Qr.qr import Ui_MainWindow
...
class QrExt(QMainWindow, Ui_MainWindow):
    ...
    def QuayLaiPhieuXacNhan(self):
        ...
        from DoAnCuoiKy.Ui.ui_PhieuXacNhan.PhieuXacNhanExt import PhieuXacNhanExt  # Import muộn
