...
from DoAnCuoiKy.Library.DataConnector import DataConnector
from DoAnCuoiKy.Ui.ui_DangNhap.login import Ui_LoginMainWindow

from DoAnCuoiKy.Ui.ui_QuanLyKhachHang.QLKHExt import QLKHExt
from DoAnCuoiKy.Ui.ui_QuanLyLichHen.QLLHExt import QLLHExt
...
class loginExt(Ui_LoginMainWindow):
    ...
    def quaylai_biachinh(self):
        from DoAnCuoiKy.Ui.ui_BiaChinh.biaExt import biaExt # Import tại đây
    ...
    def xuly_dangnhap(self):
        try:
            ...
            user_type = dc.login(username, password)
    ...
    def hienthi_tracuu_matkhau(self):
        try:
            ...
            from DoAnCuoiKy.Ui.ui_DangNhap.tracuumatkhauExt import tracuumatkhauExt  # Import động
