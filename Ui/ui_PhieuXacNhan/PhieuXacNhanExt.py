...
from DoAnCuoiKy.Ui.ui_PhieuXacNhan.PhieuXacNhan import Ui_MainWindow
from DoAnCuoiKy.Ui.ui_Qr.qrExt import QrExt
...
class PhieuXacNhanExt(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def load_customer_info(self):
        try:
            with open("../Dataset/Info_Customer.json",
    ...
    def update_customer_login(self, username, password):
        ...
        file_path = "../Dataset/Info_Customer.json"
    ...
    def save_customer_data(self):
        ...
        with open("../Dataset/Info_Customer.json", "w",
