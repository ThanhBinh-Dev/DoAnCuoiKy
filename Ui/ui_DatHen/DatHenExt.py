...
from DoAnCuoiKy.Library.JsonFileFactory import JsonFileFactory
from DoAnCuoiKy.Model.Info_customer import Info_customer
from DoAnCuoiKy.Ui.ui_DatHen.DatHen import Ui_MainWindow2


class DatHenExt(Ui_MainWindow2):
    def __init__(self):
    ...
    def XuLyDatHen(self):
        ...
        from DoAnCuoiKy.Ui.ui_PhieuXacNhan.PhieuXacNhanExt import PhieuXacNhanExt # Import muộn để tránh vòng lặp
