from DoAnCuoiKy.Model.Customer import Customer
from DoAnCuoiKy.Model.Date import Date
from DoAnCuoiKy.Model.DichVuKham import DichVuKham
from DoAnCuoiKy.Model.Time import Time


class Info_customer(Customer, Date, Time, DichVuKham):
    def __init__(self, hovaten, sdt, noikham, diachi, ngaykham, giokham, dichvu, thongtin, tendangnhap=None,
                 matkhau=None):
