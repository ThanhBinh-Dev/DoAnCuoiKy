...
"")
        ...
        self.pushButton_caution.setGeometry(QtCore.QRect(10, 0, 31, 31))
...
"QPushButton:pressed{background-color: rgb(193, 193, 193);}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("D:\\DTB\\uel\\HK1\\tu duy lap trinh\\DuongThanhBinh_K244060766_Module28\\DoAnCuoiKi\\Ui\\ui_Qr\\../../Images/Images_DatHen/back.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
