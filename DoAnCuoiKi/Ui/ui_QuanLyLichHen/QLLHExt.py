...
class QLLHExt(Ui_MainWindow):
    ...
    def setupSignalsandSlots(self):
        ...
        self.pushButtonTimKiemDK.clicked.connect(self.search_info)
        self.lineEditTimKiemDK.returnPressed.connect(self.search_info)
    ...
    def process_show_infor_detail(self,table_widget):
        ...
        if index_dichvu != -1:
            ...
            QMessageBox.warning(self.MainWindow, "Lỗi", f"Dịch vụ {info_customer.dichvu} không có trong danh sách!")
